...
class cms_model_magictree{
//	public $is_user_mess_send = false;

	function __construct(){
		$this->inDB   = cmsDatabase::getInstance();
		$this->inCore = cmsCore::getInstance();
//		$this->config = $this->inCore->loadComponentConfig('users');
//		$this->is_user_mess_send   = cmsUser::isUserCan('user/mess_send');
...
/* ==================================================================================================== */
    ...
    public function getListTreeType() {
	
		$sql = "SELECT * FROM cms_magictree_type";
    ...
    public function getListTree() {
		...
		$sql = "SELECT * FROM cms_magictree_list";
		$result = $this->inDB->query($sql);
		...
		while ($data = $this->inDB->fetch_assoc($result)){
			$data['image_folder'] = '/components/magictree/images/default/logo.gif';
			$datas[] = $data;
		}
		return $datas;
    }
    ...
    public function getTopListTree() {
	
		$sql = "SELECT * FROM cms_magictree_list ORDER BY size_tree DESC LIMIT 10";
		$result = $this->inDB->query($sql);
